...
<body>
  ...
  <div class="main-content">
    ...
    <h1>Schedule Management Solution</h1>
    <p style="margin-right: 40%; font-size: 18pt;">Dark Horse Scheduling is a centralized schedule management application that keeps the entire organization on the same page.
