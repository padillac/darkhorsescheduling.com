...
<body>
  ...
  <div class="main-content">
    ...
    <p style="margin-right: 10%; font-size: 18pt;">Dark Horse Scheduling is a centralized schedule management application that keeps the entire organization on the same page.
      ...
      Read on to learn about DHS's unique features that make everyday tasks faster and easier for employees and volunteers at all levels of your organization.</p>
    <br><br>
