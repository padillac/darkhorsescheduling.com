...
<body>
  ...
  <div class="main-content">
    ...
    <p style="margin-right: 20%; font-size: 18pt;">Dark Horse Scheduling is a centralized schedule management application that keeps the entire organization on the same page.
